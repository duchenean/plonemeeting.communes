...
from plonemeeting.communes.testing import MC_TESTING_PROFILE_FUNCTIONAL
from plonemeeting.communes.tests.helpers import MeetingCommunesTestingHelpers
...
class MeetingCommunesTestCase(PloneMeetingTestCase, MeetingCommunesTestingHelpers):
    ...
    def _configureFinancesAdvice(self, configure_custom_advisers=True, enable_add_advicecreated=False):
        ...
        self.portal.portal_setup.runAllImportStepsFromProfile(
            'profile-plonemeeting.communes:financesadvice')
