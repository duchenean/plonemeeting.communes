...
def installMeetingCommunes(context):
    ...
    portal.portal_setup.runAllImportStepsFromProfile('profile-plonemeeting.communes:default')
...
def _reorderSkinsLayers(context, site):
    ...
    site.portal_setup.runImportStepFromProfile(u'profile-plonemeeting.communes:default', 'skins')
